...
En esta carpeta se almacenan los casos de prueba organizados por aplicación/web. 
Cada subcarpeta contiene documentación específica y matrices de testing en Excel.

## 🎯 Portfolio de Testing - Multi-Rubro

| 🛒 E-commerce | 🎵 Music Streaming | 🏦 Digital Banking | 🎮 Gaming |
|:-------------:|:------------------:|:------------------:|:---------:|
| **Mercado Libre** | **Spotify** | **Revolut** | **Stardew Valley** |
| Web Platform | Mobile/Desktop App | Mobile App | Mobile/Desktop Game |
| Customer Path | UX & Performance | Security & Transactions | Gameplay & Progression |

## 📱 Aplicaciones en Testing
...
**📍 Rubro:** E-commerce  
**🚀 Plataforma:** Web  
**🎯 Focus:** Customer Path & Business Core  
...
**🎯 Focus:** Security & Financial Transactions  
...
**📍 Rubro:** Gaming  
**🚀 Plataforma:** Mobile & Desktop  
**🎯 Focus:** Gameplay & User Progression  
**💡 Por qué esta app:** Videojuego con mecánicas complejas - ideal para testing de experiencia de usuario en gaming

</div>

## 🎯 Objetivo del Portfolio

**Demostrar versatilidad en testing across diferentes industrias:**

- 🛒 **E-commerce** - Flujos business-critical y customer journey
- 🎵 **Entertainment** - Performance y experiencia de usuario
- 🏦 **Fintech** - Seguridad y transacciones financieras  
