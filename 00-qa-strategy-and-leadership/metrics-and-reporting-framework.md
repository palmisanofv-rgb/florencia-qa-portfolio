...
| **Automation ratio** | % of P1/P2 scenarios automated end-to-end | 5/9 on Project 01 (checkout/payment variants intentionally kept manual — non-idempotent payment form; the other 4 unautomated P1s are all the same checkout family, not a coverage gap); 8/10 on Project 02; 4/5 on Project 03 and Project 05; 7/7 on Project 04; full P1 automation (4/4, 5/5, or 6/6) on Projects 06–08 and 10. Automation ratio should reflect a deliberate choice, not just "everything we got to" — see [`test-strategy-master.md` §4](test-strategy-master.md) |
