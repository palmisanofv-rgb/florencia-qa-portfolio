...
Light performance smoke testing of the products/search endpoints is in scope — see [`../05-performance`](../05-performance).
...
- Traceability matrix updated (see [`../02-test-cases/traceability-matrix.md`](../02-test-cases/traceability-matrix.md))
...
| Postman / Newman | API + security testing (`../04-security-api`) |
| k6 | Performance smoke test (`../05-performance`) |
| GitHub Actions | CI execution on push |
